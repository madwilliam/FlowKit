        ...
        function obj = tiffMap(varargin)
            if nargin < 1
                ...
                if obj.SI.hFastZ.enable
                    ...
                    if (obj.SI.hStackManager.framesPerSlice==Inf) % added by CM 20180308 to compensate for hStackManager.framesPerSlice==Inf
                        obj.numframes=get_proper_frame_number(obj.fname);% added by CM 20180308 
                    else
